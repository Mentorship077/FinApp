...
//            Seniority Level
            ...
            String filter = statusEmp.filterMethodBench(entry.getKey().getStatus());
...
//                   Cost
    ...
    public void writeSheetEmp(List<Customers> customers) {
        ...
        for (int i = 0; i < RESULT_COLUMN_HEADER_NAME.size(); i++) {
            Cell cell = row.createCell(i);
            cell.setCellValue(RESULT_COLUMN_HEADER_NAME.get(i));
            cell.setCellStyle(getCellSHeaderStyle());
...
//                   Base Hours
                    ...
                    cell3.setCellValue(BASE_HOURSE);
